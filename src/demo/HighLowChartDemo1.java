...
public class HighLowChartDemo1 extends ApplicationFrame
{
	...
	{
		JFreeChart jfreechart = ChartFactory.createHighLowChart("High-Low-Open-Close Demo", "Time", "Price", ohlcdataset, true);
	...
	{
		HighLowChartDemo1 highlowchartdemo1 = new HighLowChartDemo1("JFreeChart: HighLowChartDemo1.java");

...
public class XYBarChartDemo7 extends ApplicationFrame
{
	...
	{
		JFreeChart jfreechart = ChartFactory.createXYBarChart("XYBarChartDemo7", "Date", true, "Y", intervalxydataset, PlotOrientation.HORIZONTAL, true, false, false);
	...
	{
		xyintervalseries.add(i, (double)i - 0.45000000000000001D, (double)i + 0.45000000000000001D, regulartimeperiod.getFirstMillisecond(), regulartimeperiod.getFirstMillisecond(), regulartimeperiod1.getLastMillisecond());
	}
